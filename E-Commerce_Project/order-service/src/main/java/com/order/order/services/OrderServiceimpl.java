...
public class OrderServiceimpl implements OrderService {
    ...
    public OrderDetailResponse placeOrder(String userId, PlaceOrderRequest request) {
        ...
        for (CartItem cartItem : cart.getItems()) {
            ProductServiceClient.ProductDetail live =
                productClient.getProductDetail(cartItem.getProductId());
 
            if ("OUT_OF_STOCK".equals(live.getStockStatus())
                    || live.getStockQty() < cartItem.getQuantity()) {
        ...
        cart.getItems().forEach(ci ->
            productClient.decrementStock(ci.getProductId(), ci.getQuantity()));
    ...
    public OrderDetailResponse getMyOrderDetail(String userId, String orderId) {
        ...
        PaymentServiceClient.PaymentStatus payment =
